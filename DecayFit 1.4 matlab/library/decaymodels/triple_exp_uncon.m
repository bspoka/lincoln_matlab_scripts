...
function I = triple_exp_uncon(variables)  %% 1) SET NAME OF MODEL SAME AS FILENAME
I = [];
...
default_par = [...  %% 3) DEFAULT PARAMETER VALUES: [START1 'LOWER BOUND1' 'UPPER BOUND1'; START2 'LOWER BOUND2' 'UPPER BOUND2';...]
    0.4 -1 1;... % a1 start value, lower bound, upper bound
    1 0 25;... % ...
    0.3 -1 1;...
    4 0 25;...
    0.3 -1 1;...
...
% Action:
I = a1*exp(-t/t1) + a2*exp(-t/t2) + a3*exp(-t/t3);  %% 6) DECAY MODEL
