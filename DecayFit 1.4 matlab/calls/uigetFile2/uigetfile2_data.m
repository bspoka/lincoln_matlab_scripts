function [filename, pathname, filterindex] = uigetfile2_data(varargin)
...
lastDirMat = fullfile(getappdata(0,'workdirDecayFit'),'calls','lastUsedDir','lastUsedDataDir.mat');
...
if exist(lastDirMat, 'file') ~= 0
    ...
    if (exist('lastUsedFile', 'var') == 1) && ischar(lastUsedFile) && ...
        ...
        varargin{4} = 'multiselect'; % Turn multiselection back on
        varargin{5} = 'on';
    end
end
