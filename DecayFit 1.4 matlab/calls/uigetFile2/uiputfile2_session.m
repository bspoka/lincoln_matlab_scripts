function [filename, pathname, filterindex] = uiputfile2_session(varargin)
...
lastDirMat = fullfile(getappdata(0,'workdirDecayFit'),'calls','lastUsedDir','lastUsedSessionDir.mat');
